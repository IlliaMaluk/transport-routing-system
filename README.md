...
- **Frontend (`frontend/`)**: React/TypeScript UI that visualizes routes, submits single/batch queries, and shows stats/history.
...
## Notes
- For production, harden CORS, move off SQLite, and add HTTPS in front of both services.
